...
import de.extremeenvironment.messageservice.config.liquibase.AsyncSpringLiquibase;
...
@Configuration
@EnableJpaRepositories("de.extremeenvironment.messageservice.repository")
